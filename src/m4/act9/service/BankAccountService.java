package m4.act9.service;

import m4.act9.exception.AccountNotFoundException;
import m4.act9.exception.InsufficientFundsException;
import m4.act9.exception.InvalidAccountException;
import m4.act9.exception.InvalidTransferException;
import m4.act9.model.BankAccount;
...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			String message = "Minimum initial balance: %d, Initial balance: %d";
			throw new InvalidAccountException(String.format(message, MINIMUM_INITIAL_BALANCE, initialBalance));
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (fromAccount.getBalance() < amount) {
			...
			throw new InsufficientFundsException(String.format("Balance: %d, Amount: %d", fromAccount.getBalance(), amount));
		...
		try {
			...
			// exception object
			// Pass exception 'e' as last parameter
			logger.warn("Transfer failed due to unexpected error", e);
